...
function index() {
  return (
    <AppLayout title="Job Details" >
                ...
                <div className="nl-section-blog-sidebar">
                  <NioCard>
                    <NioCard.Body className="d-flex flex-column gap-5">
                      <NioMedia rounded="circle" size="lg" variant="primary-soft" icon="file-text-fill"/>
                      <div>
                        <h5>Apply Now</h5>
                        <p className="fs-7"> If you think the responsibilities and job requirements fits your skills then you can submit you CV by clicking the button below. </p>
                      </div>
                      <NioButton href="#" label="Apply Now" className="btn-primary w-100" />
                    </NioCard.Body>
                  </NioCard>
                </div>
              </Col>
      ...
      <NioSection className="nl-section-positions">
            ...
            <Col xl="6" >
              <NioCard>
                <NioCard.Body>
                  ...
                  <p className="fs-7 line-clamp-2"> A lead backend developer is responsible for designing, developing, and managing server-side components, leading a team, and ensuring efficient and scalable backend systems. </p>
                </NioCard.Body>
              </NioCard>
            </Col>
            <Col xl="6" >
              <NioCard>
                <NioCard.Body>
                  ...
                  <p className="fs-7 line-clamp-2"> A senior product designer is an experienced professional responsible for designing and shaping user-centric product experiences, leading design initiatives, and collaborating with cross-functional teams to deliver exceptional product designs. </p>
                </NioCard.Body>
              </NioCard>
            </Col>
          </Row>
        ...
        <Row className="justify-content-center justify-content-lg-between align-items-center gx-0 pb-5 border-bottom border-lighter">
          <Col lg="6" xl="4">
            <div className="text-center text-lg-start pb-5 pb-lg-0">
              ...
              <p className="fs-7 text-dark">Join the 5000+ People That Uses Softnio Products.</p>
            </div>
          </Col>
          <Col md="10" lg="6" xl="5">
