...
export default function FaqContent() {
  ...
  return (
    <NioSection className="nl-faq-section section-space section-space-bottom">
      <div className="nl-block-head">
        <Row className="align-items-end pb-5 pb-xl-0">
          <Col xl="7">
            <div className="nl-block-head-content text-center text-xl-start m-0">
              <span className="overline-title small  mb-2 mb-md-3">faqs</span>
              <h2 className="mb-2 mb-md-0">Frequently Asked Questions</h2>
              <p className="nl-block-text lead mx-auto ms-xl-0 "> NioLand is the only saas business platform that lets you run your business on one platform, seamlessly across all digital channels.</p>
            </div>
          </Col>
          <Col xl="5">
            <ul className="d-flex gap-3 flex-wrap align-items-center justify-content-center justify-content-xl-end pt-5 pt-xl-0 ">
              <li>
